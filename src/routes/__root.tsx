...
const APP_NAME = "Радость — тату-студия в Ростове-на-Дону";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Тату-студия Радость в Ростове-на-Дону. Владислав Радость — сакральная геометрия, мини-тату и перекрытие. Рейтинг 5.0, запись по WhatsApp.",
      },
